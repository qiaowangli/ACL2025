...
echo "The provided data_path is $data_path"
    ...
    do 
        python train.py \
            ...
            --kmer -1 \
            --run_name DNABERTS_${vocab}_${lr}_tf_${data}_seed${seed} \
            --model_max_length 30 \
    ...
    do
        python train.py \
            ...
            --kmer -1 \
            --run_name DNABERTS_${vocab}_${lr}_splice_${data}_seed${seed} \
            --model_max_length 80 \
            --per_device_train_batch_size 32 \
    ...
    do
        python train.py \
            ...
            --kmer -1 \
            --run_name DNABERTS_${vocab}_${lr}_prom_${data}_seed${seed} \
            --model_max_length 20 \
            --per_device_train_batch_size 32 \
            --per_device_eval_batch_size 16 \
            --gradient_accumulation_steps 1 \
